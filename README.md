...
Analisis etika TikTok terkait digital wellbeing dan technostress menggunakan dimensi moral Laudon serta rekomendasi sistem yang lebih etis.
Digital Wellbeing dan Technostress pada Penggunaan TikTok: Analisis Etika Sistem Informasi
...
BAB II	3
2.1  Analisis Sistem, Nilai, dan Dampak Penggunaan TikTok	3
2.2 Analisis Etika Sistem	4
2.3 Ethical Decision Framework	5
2.3 Rekomendasi Kebijakan dan Desain Sistem yang Lebih Etis	6
BAB III	8
3.1  Kesimpulan	8
3.2  Referensi	8
3.3 Publish Link	9
...
Technostress merupakan kondisi stres yang muncul akibat penggunaan teknologi secara berlebihan dan tidak terkontrol (Tarafdar et al., 2007). Dalam konteks ini, paparan konten yang terus menerus dapat memicu kelelahan mental, gangguan konsentrasi, serta penurunan produktivitas. Hal ini menunjukkan bahwa teknologi memiliki sifat double edged sword, yaitu memberikan manfaat sekaligus menimbulkan dampak negatif.
...
Namun demikian, manfaat tersebut tidak terlepas dari adanya nilai yang dikorbankan. Penggunaan TikTok secara berlebihan dapat berdampak negatif terhadap kesehatan mental pengguna. Penelitian menunjukkan bahwa penggunaan media sosial secara intensif dapat menurunkan kesejahteraan individu (Kross et al., 2013). Selain itu, pola konsumsi konten yang berulang juga dapat memicu perilaku adiktif yang sulit dikendalikan (Montag et al., 2021).

Dari aspek privasi, TikTok mengumpulkan dan memanfaatkan data pengguna dalam jumlah besar untuk mendukung sistem rekomendasi. Data tersebut kemudian menjadi aset ekonomi yang digunakan untuk kepentingan bisnis, terutama dalam strategi periklanan digital (Zuboff, 2019). Hal ini menimbulkan risiko terhadap keamanan informasi pribadi serta potensi penyalahgunaan data.

Dalam konteks pihak yang terlibat, perusahaan sebagai penyedia platform dan pengiklan merupakan pihak yang paling diuntungkan karena memperoleh keuntungan dari tingginya keterlibatan pengguna. Sebaliknya, pengguna menjadi pihak yang paling berisiko dirugikan, terutama dalam hal kesehatan mental, produktivitas, dan keseimbangan hidup. Penggunaan yang tidak terkontrol dapat memicu technostress, yang berdampak pada penurunan kualitas hidup secara keseluruhan (Tarafdar et al., 2007).
...
Dimensi ketiga, accountability and control, berkaitan dengan tanggung jawab atas dampak negatif yang ditimbulkan oleh sistem. Dalam hal ini, belum terdapat kejelasan mengenai pihak yang bertanggung jawab terhadap dampak technostress dan kecanduan pengguna.

Dimensi keempat, system quality, menyoroti kualitas sistem yang digunakan. Algoritma TikTok yang dirancang untuk meningkatkan keterlibatan pengguna berpotensi menciptakan pola penggunaan yang tidak sehat, sehingga menimbulkan kecanduan (Montag et al., 2021).

Dimensi kelima, quality of life, menjadi aspek yang paling dominan karena penggunaan TikTok secara berlebihan dapat mengganggu keseimbangan hidup, menurunkan produktivitas, serta mempengaruhi kesehatan mental pengguna (Kross et al., 2013). Dalam konteks ini, technostress menjadi salah satu dampak nyata dari interaksi intensif antara manusia dan teknologi. Berdasarkan analisis tersebut, diperlukan pengembangan sistem yang lebih etis dan berorientasi pada kesejahteraan pengguna. 
...
Tahap kedua adalah penerapan pedoman dan standar etika. Dalam konteks sistem informasi, analisis dilakukan dengan mengacu pada prinsip etika dan lima dimensi moral Laudon, yaitu hak informasi, hak properti, akuntabilitas, kualitas sistem, dan kualitas hidup (Laudon & Laudon, 2013). Selain itu, konsep technostress juga menjadi acuan dalam memahami dampak psikologis dari penggunaan teknologi (Tarafdar et al., 2007). Standar ini membantu memastikan bahwa evaluasi dilakukan secara objektif dan berbasis teori yang relevan.

Tahap ketiga adalah evaluasi alternatif solusi. Beberapa alternatif yang dapat dipertimbangkan antara lain mempertahankan sistem yang ada tanpa perubahan, menambahkan fitur kontrol penggunaan seperti pembatasan waktu, serta menerapkan regulasi yang lebih ketat terkait perlindungan data. Setiap alternatif memiliki kelebihan dan kekurangan, baik dari sisi efektivitas, dampak terhadap pengguna, maupun kepentingan perusahaan.
...
Selain itu, transparansi algoritma perlu ditingkatkan agar pengguna memahami bagaimana konten ditampilkan pada platform. Dengan adanya transparansi, pengguna dapat memiliki kontrol yang lebih besar terhadap pengalaman digital mereka.

Dari sisi desain sistem, perlu dilakukan pengurangan notifikasi yang bersifat adiktif serta penerapan mekanisme peringatan ketika pengguna telah menggunakan aplikasi dalam waktu yang berlebihan. Hal ini bertujuan untuk mencegah terjadinya penggunaan yang tidak sehat.

Dari sisi kebijakan, diperlukan regulasi yang lebih ketat terkait perlindungan data pengguna. Perusahaan harus memastikan bahwa data yang dikumpulkan digunakan secara etis dan tidak merugikan pengguna.
